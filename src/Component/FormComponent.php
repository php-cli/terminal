...
final class FormComponent extends AbstractComponent
{
     ...
     */
    public function addTextField(string $name, string $label, bool $required = false, mixed $default = null): void
    {
        $this->fields[] = new TextField($name, $label, $required, $default);
    }

    /**
     * Add a checkbox field
     */
    public function addCheckboxField(string $name, string $label, bool $default = false): void
    {
        $this->fields[] = new CheckboxField($name, $label, $default);
    }

    /**
     * Add an array input field (comma-separated values)
     */
    public function addArrayField(string $name, string $label, bool $required = false): void
    {
        $this->fields[] = new ArrayField($name, $label, $required);
    }
